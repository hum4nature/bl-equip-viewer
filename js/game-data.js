...
export async function loadGameData() {
  ...
  try {
    ...
    // Note: In a real implementation, you might need to serve this file or use a different approach
    const chunkPath = '../maxroll.gg-build-planner/bl4-chunk-00-e58afd3e.js';
    
    // For now, we'll create a structure that can be populated
    // In production, you'd load the actual chunk file
    const chunkModule = await import(chunkPath).catch(() => null);
